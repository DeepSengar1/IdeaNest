...
function Webinar() {
  return (
    <div className="grid grid-cols-3 ">
      <div className="col-span-2 h-full m-2 rounded-xl bg-muted/50 p-2">
        <Card className="">
          ...
          <CardContent className="text-gray-300 text-lg">
            <p>
              Enroll in our boot camp to become a job-ready programmer by
              mastering Data Structures and Algorithms & System Design, and land
              your dream job in Product-Based Companies. Specially if you are
              introspect to shift...
            </p>
