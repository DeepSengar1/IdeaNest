    ...
    <div className='bg-black text-white min-h-screen font-sans'>
      ...
      <nav className='flex justify-between items-center p-6 border-b border-gray-700'>
        ...
        <div className='flex space-x-10 text-xl items-center'>
          ...
          {!token && <SignInButton className="bg-gradient-to-r from-purple-600 to-blue-500 text-white py-2 px-6 rounded-md hover:from-purple-700 hover:to-blue-600 transition duration-300" />}
          {/* {token && (
              <button 
              onClick={() => navigate('/')}
